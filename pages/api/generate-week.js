...
ABSOLUTE RULE — WORD BANK: You will be given a list of already-used words. Using ANY word from this list is a critical failure.

WORD SELECTION:
- The word can be ANYTHING: animal, object, food, weather, body part, sport, tool, vehicle, plant, clothing, place, action
- Pick randomly from one of these categories: Animal, Food/drink, Weather/nature, Tool/object, Human body, Sport/game, Clothing/accessory, Place/structure, Action/sound, Plant/growth
...
- NEVER use: bridge, roots, root, anchor, tide, ember, threshold, mirror, fog, echo, shadow, drift, bloom, harbor, clearing, current, gravity, weight, stillness, soil, dirt, pupil, honey, lens, scar, puddle, shell, bread, whisker

RIDDLE RULES:
- 2-3 sentences. Game show energy — witty, punchy, a little cocky.
- NEVER mention the physical category of the word
- First 1-2 sentences should fit at least 5 wrong answers
- Final sentence is ONE specific grounding detail — funny, unexpected, mundane
- Tone: smart friend giving you a hard time, not a philosopher
- NO nature metaphors, NO poetic language
- Difficulty target: 4-5 guesses average

CLUE RULES:
- Clues should NARROW not REVEAL
- CONCEPT: A property that fits the word but also fits many wrong guesses
- CONTEXT: A specific scene that hints at category without naming the thing
- BEHAVIOR: What it does — eliminates wrong guesses but doesn't confirm right one
- After all 3 clues player should be down to 2-3 possible answers, not 1
...
- Completely free — no buying, no spending
